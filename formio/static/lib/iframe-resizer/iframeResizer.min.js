...
!function (u) {
    ...
    function e(n) {
        ...
        function e() {
            var e = b.substr(I).split(":"), n = e[1] ? parseInt(e[1], 10) : 0, t = F[e[0]] && F[e[0]].iframe,
                i = getComputedStyle(t);
            return {
                iframe: t, id: e[0], height: n + function (e) {
                    ...
                    return n + e
                }(i), width: e[2], type: e[3]
            }
        }

        function i(e) {
            var n = Number(F[v]["max" + e]), t = Number(F[v]["min" + e]), i = e.toLowerCase(), e = Number(y[i]);
        ...
        function o() {
            function e() {
                return i.constructor === Array ? function () {
                    var e = 0, n = !1;
                    for (T(v, "Checking connection is from allowed list of origins: " + i); e < i.length; e++) if (i[e] === t) {
                        n = !0;
                        break
                    }
                    return n
            ...
            var t = n.origin, i = F[v] && F[v].checkOrigin;
        ...
        function d(e) {
            var n = e ? r(y.iframe) : {x: 0, y: 0}, t = {x: Number(y.width) + n.x, y: Number(y.height) + n.y};
        ...
        function u(e) {
            var n, t = e.split("#")[1] || "", e = decodeURIComponent(t),
        ...
        function f(e) {
            var n, t = {};
            t = 0 === Number(y.width) && 0 === Number(y.height) ? {x: (n = a(9).split(":"))[1], y: n[0]} : {
                x: y.width,
                y: y.height
    ...
    function d(i, e) {
        function n(t) {
            ...
            }).observe(i.parentNode, {childList: !0})), O(i, "load", function () {
                var e, n;
        ...
        function o(e) {
            ...
            }(e), Object.keys(e).forEach(t, e), function (e) {
        ...
        var r, a,
            s = ("" === (r = i.id) && (i.id = (a = e && e.id || g.id + f++, null !== document.getElementById(a) && (a += f++), r = a), l = (e || {}).log, T(r, "Added missing iframe ID: " + r + " (" + i.src + ")")), r);
