...
import { ThProjectRightSidePanelSection } from './components/project_right_side_panel_section';
import { ThProjectMilestone } from './components/project_milestone';
import { ThProjectProfitability } from './components/project_profitability';

const { Component, onWillStart, useState } = owl;

export class ThProjectRightSidePanel extends Component {
    setup() {
...
ThProjectRightSidePanel.components = { ThProjectRightSidePanelSection, ThProjectMilestone, ViewButton, ThProjectProfitability };
ThProjectRightSidePanel.template = 'th_project_itc.ProjectRightSidePanel';
ThProjectRightSidePanel.props = {
    context: Object,
    domain: Array,
};
