...
const exampleData = {
    ...
    examples:[{
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.generic");
        },
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.agilescrum");
        },
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.digitalmarketing");
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.customerfeedback");
        },
        bullets: [greenBullet, redBullet],
    }, {
        name: _lt('Consulting'),
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.consulting");
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.researchproject");
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return renderToMarkup("th_project_itc.example.tshirtprinting");
        },
        bullets: [star],
    }, {
        name: _lt('Design'),
...
kanbanExamplesRegistry.add('th_project_itc', exampleData);
