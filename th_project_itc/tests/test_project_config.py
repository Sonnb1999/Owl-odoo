...
class TestProjectConfig(TestProjectCommon):
    ...
    def setUpClass(cls):
        ...
        cls.Project = cls.env["th.project.project"]
        cls.Settings = cls.env["res.config.settings"]
        cls.features = (
            # Pairs of associated (config_flag, project_flag)
            ("th_group_subtask_project", "allow_subtasks"),
            ("th_group_project_recurring_tasks", "allow_recurring_tasks"),
            ("th_group_project_rating", "rating_active"),
            )
