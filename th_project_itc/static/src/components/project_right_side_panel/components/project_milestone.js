...
export class ThProjectMilestone extends Component {
    setup() {
    ...
    async onDeleteMilestone() {
        await this.orm.call('th.project.milestone', 'unlink', [this.milestone.id]);
...
ThProjectMilestone.props = {
    context: Object,
    milestone: Object,
    open: Function,
    load: Function,
};
ThProjectMilestone.template = 'th_project_itc.ProjectMilestone';
