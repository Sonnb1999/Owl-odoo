...
{
    'name': 'ABS Project Itc',
    'version': '1.09042024',
    'website': 'https://aum.edu.vn/',
    'category': 'AUM Business System/Project ITC',
    'sequence': 45,
    ...
    'data': [
        ...
        'views/th_project_team_view.xml',
        'views/menu.xml',
        ...
        'wizard/th_approve_pay_wizard.xml',
    ...
    'assets': {
        'web.assets_backend': [
            'th_project_itc/static/src/css/project.css',
            'th_project_itc/static/src/utils/**/*',
            'th_project_itc/static/src/services/**/*',
            'th_project_itc/static/src/components/**/*',
            'th_project_itc/static/src/views/**/*',
            'th_project_itc/static/src/js/project_activity.js',
            'th_project_itc/static/src/js/project_control_panel.js',
            'th_project_itc/static/src/js/project_graph_view.js',
            'th_project_itc/static/src/js/project_pivot_view.js',
            'th_project_itc/static/src/js/project_rating_graph_view.js',
            'th_project_itc/static/src/js/project_rating_pivot_view.js',
            # 'th_project_itc/static/src/js/project_task_kanban_examples.js',
            'th_project_itc/static/src/js/tours/project.js',
            'th_project_itc/static/src/js/widgets/*',
            'th_project_itc/static/src/scss/project_dashboard.scss',
            'th_project_itc/static/src/scss/project_form.scss',
            'th_project_itc/static/src/scss/project_widgets.scss',
            'th_project_itc/static/src/xml/**/*',
        ],
        'web.assets_frontend': [
            'th_project_itc/static/src/scss/portal_rating.scss',
            'th_project_itc/static/src/scss/project_sharing_frontend.scss',
            'th_project_itc/static/src/js/portal_rating.js',
        ],

        'web.qunit_suite_tests': [
            # 'th_project_itc/static/tests/**/*.js',
        ],
        'web.assets_tests': [
            'th_project_itc/static/tests/tours/**/*',
        ],
        'project.webclient': [
            ...
            'th_project_itc/static/src/components/project_task_name_with_subtask_count_char_field/*',
            'th_project_itc/static/src/views/project_task_form/*.scss',

            'th_project_itc/static/src/project_sharing/search/favorite_menu/custom_favorite_item.xml',
            'th_project_itc/static/src/project_sharing/**/*',
